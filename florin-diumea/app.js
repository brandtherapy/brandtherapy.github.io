    ...
    "archetypes": [
      {
        "id": "outlaw",
        "name": "Outlaw",
        "promise": "Break the rule that deserves breaking.",
        "description": "Disrupts convention and challenges what is not working.",
        "weight": 7,
        "role": "trace"
      },
      {
        "id": "magician",
        "name": "Magician",
        "promise": "Make the transformation feel inevitable.",
        "description": "Turns a vision into a experienced, felt reality.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "hero",
        "name": "Hero",
        "promise": "Prove it is possible through action.",
        "description": "Rises to the challenge and does the hard thing first.",
        "weight": 18,
        "role": "secondary"
      },
      {
        "id": "lover",
        "name": "Lover",
        "promise": "Make the connection feel personal.",
        "description": "Creates intimacy, appreciation, and belonging.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "jester",
        "name": "Jester",
        "promise": "Make the truth easy to hear.",
        "description": "Uses humor and lightness to say what is real.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "friend",
        "name": "Friend",
        "promise": "Show up like someone who is actually in it with you.",
        "description": "Builds trust through reliability and shared ground.",
        "weight": 15,
        "role": "supporting"
      },
      {
        "id": "caregiver",
        "name": "Caregiver",
        "promise": "Take care of what others overlook.",
        "description": "Protects, supports, and puts others' needs first.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "ruler",
        "name": "Ruler",
        "promise": "Hold the standard, even when it costs something.",
        "description": "Creates order, structure, and a durable system.",
        "weight": 20,
        "role": "secondary"
      },
      {
        "id": "creator",
        "name": "Creator",
        "promise": "Build the thing that should exist.",
        "description": "Turns ideas into original, tangible work.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "innocent",
        "name": "Innocent",
        "promise": "Keep it simple and honest.",
        "description": "Offers optimism, plain dealing, and a clean slate.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "sage",
        "name": "Sage",
        "promise": "Give the read that actually helps someone decide.",
        "description": "Seeks the truth and shares it plainly.",
        "weight": 30,
        "role": "primary"
      },
      {
        "id": "explorer",
        "name": "Explorer",
        "promise": "Keep moving toward what is next.",
        "description": "Seeks growth, freedom, and new ground.",
        "weight": 10,
        "role": "trace"
      }
    ],
