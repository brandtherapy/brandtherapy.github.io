(function () {
  ...
  const ARCHETYPE_MIX = {
    ...
    "media_base": "assets/archetype-chart/portraits/female",
    "archetypes": [
      {
        "id": "outlaw",
        "name": "Outlaw",
        "promise": "Rules are made to be broken",
        "description": "Disrupts convention and breaks the rules to create change.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "magician",
        "name": "Magician",
        "promise": "Makes dreams come true",
        "description": "Transforms situations and turns a vision into reality.",
        "weight": 0,
        "role": "none"
      },
      {
        ...
        "description": "Rises to the challenge and proves worth through decisive action.",
        "weight": 35,
        "role": "secondary"
      },
      {
        ...
        "description": "Creates intimacy, passion, and connection.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "jester",
        "name": "Jester",
        "promise": "You only live once",
        "description": "Brings joy and lightens the moment with humor.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "friend",
        "name": "Friend",
        "promise": "We're better together",
        "description": "Belongs, and builds honest, down to earth relationships.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "caregiver",
        "name": "Caregiver",
        "promise": "Let me help you",
        "description": "Protects, reassures, and cares for others before self.",
        "weight": 40,
        "role": "primary"
      },
      {
        ...
        "description": "Takes control and creates order out of chaos.",
        "weight": 0,
        "role": "none"
      },
      {
        "id": "creator",
        "name": "Creator",
        "promise": "If it can be imagined, it can be created",
        "description": "Builds new things and turns imagination into original work.",
        "weight": 25,
        "role": "supporting"
      },
      {
        "id": "innocent",
        "name": "Innocent",
        "promise": "Free to be you and me",
        "description": "Seeks happiness and does things the right way.",
        "weight": 0,
        "role": "none"
      },
      {
        ...
        "description": "Seeks the truth through knowledge and understanding.",
        "weight": 0,
        "role": "none"
      },
      {
        ...
        "description": "Seeks freedom and discovers new frontiers.",
        "weight": 0,
        "role": "none"
      }
    ],
