  ...
  "pillars": [
    {
      ...
      "guide": {
        "desc": "<strong>Product.</strong> Bring the missing context into view. Make complexity usable without flattening it into an automatic answer.",
        "impacts": [
          "Strategy",
          "Writing",
          "Visuals",
      ...
      "case": {
        ...
        "apply": "Keep this point connected to the full Focus Star.",
        "impacts": [
          "Strategy",
          "Writing",
          "Visuals",
    ...
    },
    {
      ...
      "eyebrow": "Your tribe",
      "guide": {
        "desc": "<strong>People.</strong> Speak to the person who would rather examine the whole picture than borrow someone else&#x27;s certainty.",
        "impacts": [
          "Strategy",
          "Writing",
          "Visuals",
    ...
    },
    {
      ...
      "eyebrow": "Your why",
      "guide": {
        "desc": "<strong>Purpose.</strong> Put more truth, context, creativity, and human judgment into the choices that shape work, culture, technology, and civic life.",
        "impacts": [
          "Strategy",
          "Writing",
          "Visuals",
    ...
    },
    {
      ...
      "guide": {
        "desc": "<strong>Promise.</strong> Question first. Gather the fuller picture. Let evidence and human judgment close the inquiry into a choice.",
        "impacts": [
          "Strategy",
          "Writing",
          "Visuals",
    ...
    },
    {
      ...
      "guide": {
        "desc": "<strong>Personality.</strong> Erudite but unpretentious. Serious but playful. Rational with room for art, intuition, mystery, and revision.",
        "impacts": [
          "Strategy",
          "Writing",
          "Visuals",
